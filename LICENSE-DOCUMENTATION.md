...
Unless otherwise noted, all documentation, research notes, explanatory text, and non-source-code materials in this repository are licensed under the Creative Commons Attribution 4.0 International License (CC BY 4.0).
