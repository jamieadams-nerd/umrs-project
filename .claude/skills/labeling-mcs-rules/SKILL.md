---
name: labeling-mcs-rules
description: >
  MCS labeling and CUI catalog rules: setrans.conf format, category range assignments,
  Five Eyes nation catalogs, LEVELS.json, and label synchronization requirements. Use this
  skill when working with MCS, setrans, category, c300, Five Eyes, LEVELS.json, CUI catalog,
  CANADIAN-PROTECTED, US-CUI-LABELS, setrans.conf, or MCS category content. Trigger when
  editing label catalogs, assigning MCS categories, or working with umrs-labels.
---
