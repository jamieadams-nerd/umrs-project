---
name: cui-taxonomy-rules
description: >
  CUI taxonomy, banner marking syntax, category abbreviations, LDC rules, and UMRS JSON
  catalog field mappings. Use this skill when working with CUI, banner, marking, taxonomy,
  NARA, LDC, dissemination, SP-CTI, index group, category abbreviation, CUI Basic, or
  CUI Specified content. Trigger when constructing or validating CUI banner strings,
  editing label catalog JSON, or working with dissemination controls.
---
