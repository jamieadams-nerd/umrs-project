---
name: knowledge-mgmt-rules
description: >
  Knowledge management rules for the UMRS reference library: document acquisition,
  RAG ingestion vs familiarization decisions, collection naming, storage layout, version
  tracking, and decommissioning. Use this skill when working with RAG, reference library,
  corpus, ingestion, familiarization, collection, acquisition, refs-manifest, or ChromaDB.
  Trigger when acquiring new reference documents, managing RAG collections, or deciding
  whether to ingest or familiarize with new material.
---
