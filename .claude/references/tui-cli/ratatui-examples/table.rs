// Ratatui interactive table example — main.rs
...
// Fetched: 2026-03-15
//
// Tags: Table, TableState, StatefulWidget, Scrollbar, ScrollbarState, Row, Cell,
//       HighlightSpacing, column-selection, row-selection, cell-selection,
//       Tailwind palette, keyboard navigation
//
// Demonstrates: interactive table with row/column/cell selection, scrollbar integration,
//               dynamic column widths via unicode_width, tailwind color palette usage,
//               stateful widget pattern (App owns TableState + ScrollbarState)
