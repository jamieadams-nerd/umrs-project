...
// Fetched: 2026-03-15
//
// Tags: tabs, multi-tab, event-handling, widget-composition, App-struct, StatefulWidget,
//       Layout::vertical, Layout::horizontal, Constraint, Tabs, Block, Span, Line
//
// Demonstrates: multi-tab application structure, App-as-Widget pattern (impl Widget for &App),
//               keyboard event handling, nested layout (title bar + content + bottom bar),
//               mode-based state machine (Running/Destroy/Quit)
