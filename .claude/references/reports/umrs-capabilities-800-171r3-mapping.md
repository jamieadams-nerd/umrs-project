...
**Primary source:** NIST SP 800-171 Rev 3 (May 2024), `.claude/references/nist/sp800-171r3.pdf`
**Secondary source:** CMMC Assessment Guide Level 2 v2.13, `.claude/references/dod-5200/cmmc-assessment-guide-l2.pdf`
...
- `.claude/references/nist/sp800-171r3.pdf` (SHA-256: `3e4631df8b5d61f40a6e542b52779ef30ddbbfff31e09214fa94ad6e6f5e6d08`)
  Pages 6–74 (document pages, offset from PDF pages by approximately 10)
- Manifest entry: `.claude/references/refs-manifest.md`
