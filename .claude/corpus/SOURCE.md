...
`/media/psf/repos/umrs-project/.claude/corpus/termium-military-security-raw.zip`
then run `python3 /media/psf/repos/umrs-project/refs/extract_termium.py` to process it.
...
2. Re-run `python3 /media/psf/repos/umrs-project/refs/extract_termium.py`
3. Re-run `python3 /media/psf/repos/umrs-project/refs/extract_gdt.py`
4. Re-run `python3 /media/psf/repos/umrs-project/refs/parse_termium_glossary3.py`
5. Re-run `python3 /media/psf/repos/umrs-project/refs/parse_cccs_bilingual.py`
