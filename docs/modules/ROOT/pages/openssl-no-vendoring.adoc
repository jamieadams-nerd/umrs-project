...
*Step 2*. Confirm you are dynamically linking to the system _libssl/libcrypto_ by running:
[bash,source]
----
...
*Step 4*. Look for a vendored build artifact (optional sanity check)
...
What I recommend you standardize in UMRS builds
