...
LATE 1990s–2000s: Security Enhanced Linux (SELinux)

SELinux emerged from NSA research in the late 1990s with assistance from Trusted Computer Solutions and Tresys.
...
Virtualization and hardware enforced sepration shifts MLS ideas “downward” into hardware and virtualization layers.
