...
The correct sequence is:
	...
	. Fix policy issues
	. Tighten scope
	. Only then scale capacity (hardware and architecture)
...
⸻
	...
	. SECOND PHASE: HANDLE SELINUX AVC NOISE (CRITICAL)
...
⸻
	...
	. THIRD PHASE: FURTHER AUDIT SCOPE REDUCTION TECHNIQUES
...
⸻
	...
	. AFTER NOISE REDUCTION: SCALING AND CAPACITY STRATEGIES
...
⸻
	...
	. HOW RED HAT EXPECTS THIS TO BE DONE

⸻

Red Hat’s implicit, repeated guidance is:
	1.	Reduce event volume through precise rules
	. Fix SELinux policy instead of logging denials forever
	. Size systems appropriately after scope is minimized
	. Preserve filesystem and audit integrity
	. Prefer buffering and isolation over unsafe tuning
...
⸻
	...
	. FOUNDATIONAL TRUTH (SET CONTEXT)
...
You always do this in order:
	1.	Reduce audit noise
	. Fix policy errors
	. Scope audit rules tightly
	. Then scale hardware or architecture
...
⸻
	...
	. PATH WATCHES: WHAT TO REMOVE AND WHAT TO KEEP
...
⸻
	...
	. SELINUX AVC NOISE – PRACTICAL EXAMPLES
...
⸻
	...
	. AFTER NOISE REDUCTION: SCALING THE SYSTEM
...
⸻
	...
	. DOES SECCOMP HELP WITH AUDIT NOISE?
...
⸻
	...
	. IMPORTANT WARNING ABOUT SECCOMP + AUDIT
...
⸻
	...
	. Filter syscalls aggressively
	. Audit humans, not daemons
	. Fix SELinux policy
	. Suppress only verified-benign AVCs
	. Eliminate duplicate logging
	. Remove investigative leftovers
	. Then scale RAM and storage
	. Optionally use seccomp as prevention
