...
*** xref:team/jamie.adoc[Jamie — The Imodium Operator]
*** xref:team/henry.adoc[Henry — The Hand]
*** xref:team/herb.adoc[Herb — The IRS]
*** xref:team/sage.adoc[Savannah — Sage]
*** xref:team/rusty.adoc[Rusty]
*** xref:team/the-librarian.adoc[The Librarian]
*** xref:team/knox.adoc[Knox — The Lorekeeper]
*** xref:team/simone.adoc[Simone]
*** xref:team/elena.adoc[Elena — The Imprimatur]
*** xref:team/lucia.adoc[Lucia]
*** xref:team/henri.adoc[Henri Bélanger]
*** xref:team/hamlet.adoc[Hamlet]
*** xref:team/nora-and-finn.adoc[Nora & Finn — The Interns]
