...
Got it. Below is a fully consolidated, plain-text, unformatted answer that combines the previous discussion with the next-stage scaling strategies once audit noise has been reduced. This is written as a single coherent guidance block you can use for design docs, operations manuals, or audit justification.
...
⸻
	...
	2.	FIRST PHASE: REDUCE AUDIT NOISE AT THE SOURCE
