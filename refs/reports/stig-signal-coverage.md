...
**CMMC reference:** `refs/dod/cmmc-assessment-guide-l2.pdf`
...
The CMMC Assessment Guide L2 (v2.13, `refs/dod/cmmc-assessment-guide-l2.pdf`) maps 110 practices
...
| CMMC Assessment Guide Level 2 v2.13 | `refs/dod/cmmc-assessment-guide-l2.pdf` | Downloaded (manifest entry exists) |

### Requires Manual / Privileged Download — Flag for Jamie

| Document | Source URL | Notes |
|---|---|---|
| DISA RHEL 9 STIG v2r5 (ZIP) | `https://dl.dod.cyber.mil/wp-content/uploads/stigs/zip/U_RHEL_9_V2R5_STIG.zip` | HTTP 200 confirmed; requires Bash/curl write permission to `refs/dod/stig/`. Contains XCCDF and SCAP content. Useful as RHEL 10 STIG precursor. |
...
- CCE cross-reference: `.claude/references/scap-security-guide/cce-nist-crossref.md`
- CMMC Assessment Guide: `refs/dod/cmmc-assessment-guide-l2.pdf`
