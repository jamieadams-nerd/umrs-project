...
Below is a clear, concise, accurate-as-possible historical overview of HACAMS — where the term came from, its DARPA lineage, how it fit into MLS/CDS evolution, and how it faded into modern terminology.

NOTE: HACAMS was never a single commercial product. It was a DARPA-originated concept and research program category, later adopted into government lexicon for high-assurance cross-domain access control.
...
These were not public commercial documents but DoD/IC research and program documents tied to early MLS workstations and domain bridging systems.
	4.	HOW HACAMS FIT INTO THE MLS ERA
...
“identity + policy + audit + domain mapping for multi-level environments.”
	5.	TRANSITION INTO THE CROSS-DOMAIN (CDS) ERA
