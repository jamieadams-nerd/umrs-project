...
pub fn render_data_panel(
    ...
    let scroll_area = if pinned.is_empty() {
        ...
        #[expect(
            ...
            reason = "pinned_height is clamped to 40% of area.height (u16), so it fits in u16"
        )]
...
#[expect(
    ...
    reason = "indicator row renderer requires independent params for key, value, description, styles, and layout context"
)]
