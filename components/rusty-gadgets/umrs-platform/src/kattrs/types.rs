...
//!
//! NIST 800-53 AC-3: Access Enforcement — `EnforceState` is the canonical
...
///
/// NIST 800-53 AC-3: Access Enforcement — this value directly determines
...
/// uncommitted pending state separately.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct DualBool {
    pub current: bool,
    pub pending: bool,
