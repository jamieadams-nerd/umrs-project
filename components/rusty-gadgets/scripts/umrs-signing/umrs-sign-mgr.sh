...
#   umrs-sign-mgr.sh [global options]  [args]
#
# Global options:
...
#
# Examples:
#   umrs-sign-mgr.sh init
#   umrs-sign-mgr.sh -b /etc/pki/my-signing init
#   umrs-sign-mgr.sh -A ecdsa -L secp384r1 init
#   umrs-sign-mgr.sh rotate all
#   umrs-sign-mgr.sh report
#   umrs-sign-mgr.sh bundle-public /root/ha-public-keys.tar.gz
###############################################################################
